        ...
        <main>
          ...
          >
            <div className="wrapper">
              <TextBlur
                paragraphs={[
                  'Welcome to LOIRIEN Mara, a sanctuary nestled within the private Partakilat Conservancy in the heart of the Maasai Mara. The name "Loirien," signifies the sacred Masaai Olive Tree and a place of refuge, embodying a peaceful retreat amidst the wilderness.',
                ]}
                style="heading"
                reference="title"
              />
          ...
          <section id="ourstory-parallax">
            ...
            >
              <div className="text">
                ...
                or explore the wild landscapes of the Mara through fly camping
